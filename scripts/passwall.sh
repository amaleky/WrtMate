...
server_less() {
  ...
  curl -s -L -o "/root/xray/subscription.json" "https://raw.githubusercontent.com/patterniha/Serverless-for-Iran/main/Subscription/Serverless-for-Iran.json" || error "Failed to download ServerLess configs list."
