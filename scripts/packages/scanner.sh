...
main() {
  ...
  curl -L -o "/usr/bin/scanner" "https://github.com/amaleky/WrtMate/releases/latest/download/scanner_linux-${DETECTED_OS}-${DETECTED_ARCH}" || echo "Failed to download scanner."
